Source code for the current draft of *Efficient Machine Learning with R*, a book on making your tidymodels code run faster without sacrificing predictive performance.
